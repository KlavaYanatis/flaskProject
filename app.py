...
# mail = Mail(app)
#
# def send_email(text_body='Проверочное сообщение, если не указанно, что-то другое', html_body='<b>HTML</b> body', subject='Форма обратной связи', sender=ADMINS[0], recipients=ADMINS):
...
def new_post():
    if request.method == 'POST':
        ...
        try:
            ...
            '''try:
                subject = "Сообщение отправленно"
               #send_mail(subject, article,'Tatyart.Knid@gmail.com',['Tatyart.Knid@gmail.com'])
